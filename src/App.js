...
function App() {
  ...
  <div className=" bg-bg-MASTER">
    ...
    <div class="flex items-center">
     <Link to="/">
        <img src={defaultLogo} alt="Dr. MechNY Logo" style={{ width: '40px', height: '40px' }} />
      </Link>
...
<nav className="flex justify-end space-x-4 bg-bg-nav-bar p-4">
  <Link to="/" className="text-gray-600 hover:font-bold">Home</Link>
  {!user ? (
    <>
      <Link to="/register" className="text-gray-600 hover:font-bold">Register</Link>
      <Link to="/login" className="text-gray-600 hover:font-bold">Login</Link>
    </>
  ) : (
    <>
      <Link to="/account" className="text-gray-600 hover:font-bold">Account</Link>
      <Link to="/my-vehicle" className="text-gray-600 hover:font-bold">My Vehicle</Link>
      <Link to="/add-vehicle" className="text-gray-600 hover:font-bold">Register Vehicle</Link>
      <Link to="/my-appointment" className="text-gray-600 hover:font-bold">My Appointment</Link>
      <Link to="/appointment-booking" className="text-gray-600 hover:font-bold">Appointment Booking</Link>
      <Link to="/vehicle-service-details" className="text-gray-600 hover:font-bold">Service Details</Link>
      <Link 
        to="/" 
